...
document.getElementById("mybtn").addEventListener("click",function(){
	...
	var mybox=document.getElementById("outer");
...
var gTitleItemType="item type eg. Round, Scrap, Bar etc.";
var gTitleItemCategory="item category eg. MS, Class, EN etc.";
var gTitleItemDimension="item dimension eg. Length, Width, Dia, Bore etc.";
var gMsgNoChanges="No changes made !";
var gVirtualId='999912319999';
/*	these are the common j-query gets executed on every page 
 *  where ever from date to date are involved this will call the calendar
 * 
 * */
$(function() {
